...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Anonymised client matters. Illustrative only - all identifying detail changed.';
  ...
  attributes: {
    ...
    practiceArea: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiContactSubmissionContactSubmission
  ...
  info: {
    description: 'Enquiries from the contact form. Never publicly readable.';
  ...
  attributes: {
    ...
    subject: Schema.Attribute.String;
    submittedLocale: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    sectionImages: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiLandingPageLandingPage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Campaign landing pages for paid search. Served noindex and kept out of the sitemap, because each one duplicates a service page that already ranks organically.';
...
export interface ApiOfficeOffice extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Abu Dhabi, Mansoura and New Delhi. Drives per-office LocalBusiness schema.';
    displayName: 'Office';
    pluralName: 'offices';
    singularName: 'office';
  };
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Service and informational pages migrated from WordPress';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog articles and editorial guides';
    displayName: 'Insight';
    pluralName: 'posts';
    singularName: 'post';
  };
...
export interface ApiPracticeAreaPracticeArea
  ...
  info: {
    description: 'The five service pillars that head the navigation';
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutLinks: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    siteName: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Fakher & Co'>;
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Advocates and consultants';
  ...
  attributes: {
    barAdmissions: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
